...
# This version uses OECD countries as the benchmarking set
...
dat_countries <- tribble(
  ...
  "Austria", "AT", "Europe", 
  "Belgium", "BE", "Europe", 
  "Canada", "CA", "Americas + Israel", 
  "Chile", "CL", "Americas + Israel", 
  "Colombia", "CO", "Americas + Israel", 
  "Costa Rica", "CR", "Americas + Israel", 
  "Czechia", "CZ", "Europe", 
  "Denmark", "DK", "Europe", 
  "Estonia", "EE", "Europe", 
  "Finland", "FI", "Europe", 
  ...
  "Iceland", "IS", "Europe", 
  "Ireland", "IE", "Europe", 
  "Israel", "IL", "Americas + Israel", 
  "Italy", "IT", "Europe", 
  "Japan", "JP", "Australasia", 
  "Latvia", "LV", "Europe", 
  "Lithuania", "LH", "Europe", 
  "Luxembourg", "LU", "Europe", 
  "Mexico", "MX", "Americas + Israel",
  ...
  "United States", "US", "Americas + Israel"
) |> 
...
chart <- dat_chart |> 
  ...
  facetted_pos_scales(y = list(
    scale_y_continuous(breaks = seq(0, max_mean_daily_new_cases_per_5m, 1000),
    ...
    scale_y_continuous(breaks = seq(0, max_mean_total_cases_per_5m, 100000),
                       ...
                       expand = expansion(0, 0),
                       position = "right"), 
    scale_y_continuous(breaks = seq(0, max_mean_daily_new_deaths_per_5m, 5),
                       limits = c(-1, max_mean_daily_new_deaths_per_5m),
                       expand = expansion(0, 0),
                       position = "right"),
    scale_y_continuous(breaks = seq(0, max_mean_total_deaths_per_5m, 2000),
                       limits = c(-200, max_mean_total_deaths_per_5m),
                       expand = expansion(0, 0),
                       labels = comma_format(accuracy = 1),
                       position = "right"),
  ...
  scale_fill_manual(values = c("New Zealand" = "#6929c4", 
                               ...
                               "Americas + Israel" = lighten(col = "#ff7eb6", amount = 0.2)),
                    name = NULL, 
                    aesthetics = c("colour", "fill")) +
  labs(title = glue("COVID-19 benchmarks from OECD countries for {last_date}"), 
